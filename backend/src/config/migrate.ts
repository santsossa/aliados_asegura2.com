...
const MODIFY_STMTS = [
  ...
  // v4 — sub-estados adicionales para el flujo del CRM
  `ALTER TABLE polizas MODIFY COLUMN estado ENUM('en_proceso','en_contacto','poliza_emitida','aprobada','no_convertida') NOT NULL DEFAULT 'en_proceso'`,
]
