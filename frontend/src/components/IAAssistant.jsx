...
export default function IAAssistant() {
  ...
  return (
    <div style={{ position:'fixed', bottom:24, right:24, zIndex:300, display:'flex', alignItems:'flex-end' }}>
      ...
      {/* Contenedor principal — column-reverse para que el input quede siempre visible al fondo */}
      <div
        ref={pillRef}
        ...
        style={{
          ...
          overflow:      'hidden',
          display:       'flex',
          flexDirection: 'column-reverse',  // input al fondo siempre, chat crece hacia arriba
      ...
      >
        ...
        {/* Input — PRIMERO en DOM = fondo en column-reverse */}
        {open && (
          <div style={{
        ...
        {/* Separador — SEGUNDO en DOM = encima del input */}
        {open && chatH > 0 && (
          <div style={{ height:1, background:'#f0f0f2', flexShrink:0 }} />
        )}

        {/* Área de mensajes — TERCERO en DOM = arriba del todo */}
        {open && (
          <div
            style={{
              flex: 1,
